/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 26e9565c0085e9a8d9d15a0cfdc1ea0a)
// Runtime types generated with workerd@1.20260714.1 2026-07-21 nodejs_compat
interface __BaseEnv_Env {
	BOARD_DATA: R2Bucket;
	ASSETS: Fetcher;
	BOARD_UUID: string;
	KANBAN_BOARD: DurableObjectNamespace<import("./worker/index").KanbanBoard>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "KanbanBoard";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOARD_UUID">> {}
}
